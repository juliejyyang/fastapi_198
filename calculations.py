...
# removes noisy readings / outliers
# returns filtered list of readings
...
# calculates second derivative of temp changes over time
# higher values indicate more drastic temp changes
